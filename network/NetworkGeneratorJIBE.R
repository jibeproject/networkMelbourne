...
sink(paste0('./',outputDir,'/makeMatsimNetworkJIBE.log'), append=FALSE, split=TRUE)
...
st_write(networkFinalDirect[[2]], paste0(outputDir,'/networkDirect.sqlite'), 
         ...
         delete_layer = T)
st_write(networkFinalDirect[[1]], paste0(outputDir,'/networkDirect.sqlite'),
...
# if(writeSqlite) system.time(exportSQlite(networkFinalDirect, paste0(outputDir,"Direct")))
